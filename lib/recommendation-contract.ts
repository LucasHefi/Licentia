...
const guideQuestions: GuideQuestion[] = [
  {
    ...
    key: "openness",
    mode: "quick",
    title: "Jak otevřený má software být?",
    help: "Zvolte otevřenou licenci nebo možnost uzavřeného použití. Sdílení úprav nastavíte zvlášť.",
    options: [
      {"value": "open", "label": "Otevřený software", "description": "Upřednostní otevřené licence. Povinné sdílení úprav určíte v otázce o změnách."},
      {"value": "closed", "label": "Povolím uzavřené použití", "description": "Upřednostní licence bez povinného sdílení úprav a upozorní na samostatné uzavřené podmínky."},
      {"value": "unknown", "label": "Nevím", "description": "Chybí mi informace. Tato odpověď pořadí neovlivní a zůstane označená jako neznámá."},
      {"value": "not-applicable", "label": "Není relevantní", "description": "Tento požadavek se projektu netýká. Při řazení licencí se vynechá."},
      {"value": "undecided", "label": "Nerozhodnuto", "description": "Volbu nechám na později. Zatím pořadí neovlivní; odpověď mohu změnit."},
    ],
  },
  {
    id: "q-project-form",
    ...
    mode: "quick",
    title: "Co vytváříte?",
    help: "Vyberte typ projektu. Tato odpověď popisuje váš záměr a sama pořadí licencí nemění.",
    options: [
      {"value": "application", "label": "Aplikaci", "description": "Zaznamená samostatný program. Způsob jeho předání určíte zvlášť."},
      {"value": "library", "label": "Knihovnu", "description": "Zaznamená kód pro použití v jiných programech. Sdílení úprav knihovny určíte zvlášť."},
      {"value": "service", "label": "Online službu", "description": "Zaznamená službu pro vzdálené uživatele. Podmínky síťového provozu určíte zvlášť."},
      {"value": "unknown", "label": "Nevím", "description": "Chybí mi informace. Tato odpověď pořadí neovlivní a zůstane označená jako neznámá."},
      {"value": "not-applicable", "label": "Není relevantní", "description": "Tento požadavek se projektu netýká. Při řazení licencí se vynechá."},
      {"value": "undecided", "label": "Nerozhodnuto", "description": "Volbu nechám na později. Zatím pořadí neovlivní; odpověď mohu změnit."},
    ],
  },
  {
    ...
    key: "reciprocity",
    mode: "quick",
    title: "Které úpravy mají ostatní sdílet?",
    help: "Určete rozsah kódu, jehož úpravy se mají sdílet. Přesné podmínky určuje vybraná licence.",
    options: [
      {"value": "none", "label": "Bez povinného sdílení", "description": "Upřednostní licence, které nevyžadují sdílení zdrojového kódu úprav."},
      {"value": "file", "label": "Pokryté soubory", "description": "Upřednostní sdílení úprav souborů pod touto licencí; oddělené soubory mohou mít jiné podmínky."},
      {"value": "library", "label": "Knihovnu", "description": "Upřednostní sdílení úprav knihovny s možností připojit ji k jinak licencované aplikaci."},
      {"value": "strong", "label": "Celé odvozené dílo", "description": "Upřednostní licence požadující sdílení zdrojů celého odvozeného díla při jeho šíření."},
      {"value": "network", "label": "Také při provozu v síti", "description": "Upřednostní licence s povinností poskytnout zdroje i uživatelům upravené síťové služby."},
      {"value": "unknown", "label": "Nevím", "description": "Chybí mi informace. Tato odpověď pořadí neovlivní a zůstane označená jako neznámá."},
      {"value": "not-applicable", "label": "Není relevantní", "description": "Tento požadavek se projektu netýká. Při řazení licencí se vynechá."},
      {"value": "undecided", "label": "Nerozhodnuto", "description": "Volbu nechám na později. Zatím pořadí neovlivní; odpověď mohu změnit."},
    ],
  },
  {
    ...
    key: "commercialUse",
    mode: "quick",
    title: "Chcete povolit komerční použití?",
    help: "Rozhodujete, zda ostatní mohou software používat i k podnikání nebo prodeji.",
    options: [
      {"value": "allowed", "label": "Ano, povolím", "description": "Upřednostní licence s doloženým oprávněním ke komerčnímu použití."},
      {"value": "restricted", "label": "Chci ho omezit", "description": "Označí výsledek k ručnímu posouzení: omezení komerčního použití průvodce neumí ověřit."},
      {"value": "unknown", "label": "Nevím", "description": "Chybí mi informace. Tato odpověď pořadí neovlivní a zůstane označená jako neznámá."},
      {"value": "not-applicable", "label": "Není relevantní", "description": "Tento požadavek se projektu netýká. Při řazení licencí se vynechá."},
      {"value": "undecided", "label": "Nerozhodnuto", "description": "Volbu nechám na později. Zatím pořadí neovlivní; odpověď mohu změnit."},
    ],
  },
  {
    ...
    key: "delivery",
    mode: "quick",
    title: "Jak se software dostane k uživatelům?",
    help: "Předání kopie programu a provoz online služby mohou mít jiné licenční povinnosti.",
    options: [
      {"value": "application", "label": "Předám aplikaci", "description": "Přidá otázku na licence závislostí. Do jejího vyplnění se řazení pozastaví."},
      {"value": "library", "label": "Předám knihovnu", "description": "Zaznamená distribuci knihovny. Samotná tato volba pořadí licencí nemění."},
      {"value": "saas", "label": "Zpřístupním online službu", "description": "Zaznamená provoz přes síť. Sdílení zdrojů nastavte v otázce o úpravách."},
      {"value": "internal", "label": "Jen uvnitř organizace", "description": "Vynechá otázku na závislosti distribuované aplikace; tato volba sama licence nepřeskupí."},
      {"value": "unknown", "label": "Nevím", "description": "Chybí mi informace. Tato odpověď pořadí neovlivní a zůstane označená jako neznámá."},
      {"value": "not-applicable", "label": "Není relevantní", "description": "Tento požadavek se projektu netýká. Při řazení licencí se vynechá."},
      {"value": "undecided", "label": "Nerozhodnuto", "description": "Volbu nechám na později. Zatím pořadí neovlivní; odpověď mohu změnit."},
    ],
  ...
  {
    id: "q-dependencies-quick",
    key: "dependencies",
    mode: "quick",
    title: "Jaké licence mají vaše závislosti?",
    help: "Zadejte licence cizího kódu ve formátu SPDX, například MIT AND Apache-2.0, nebo zvolte odpověď níže.",
    showWhen: {"key": "delivery", "equals": "application"},
    options: [
      {"value": "unknown", "label": "Nevím", "description": "Pokračuje bez ověření závislostí. Jejich licence bude nutné zjistit před použitím výsledku."},
      {"value": "not-applicable", "label": "Nemám cizí závislosti", "description": "Zaznamená, že nepoužíváte cizí kód; řazení bude pokračovat bez kontroly závislostí."},
      {"value": "undecided", "label": "Doplním později", "description": "Pokračuje bez ověření závislostí. Jejich licence můžete zadat po návratu k této otázce."},
    ],
  },
  {
    id: "q-patents-quick",
    key: "patents",
    mode: "quick",
    title: "Chcete výslovné patentové oprávnění?",
    help: "Patentové oprávnění dovoluje využít patenty v rozsahu licence. Samotné podmínky patentového sporu nestačí.",
    options: [
      {"value": "important", "label": "Ano, je důležité", "description": "Upřednostní licence s doloženým výslovným patentovým oprávněním."},
      {"value": "neutral", "label": "Není podmínkou", "description": "Patentové oprávnění nebude nutné; zohlední se, zda je patentové postavení licence známé."},
      {"value": "unknown", "label": "Nevím", "description": "Chybí mi informace. Tato odpověď pořadí neovlivní a zůstane označená jako neznámá."},
      {"value": "not-applicable", "label": "Není relevantní", "description": "Tento požadavek se projektu netýká. Při řazení licencí se vynechá."},
      {"value": "undecided", "label": "Nerozhodnuto", "description": "Volbu nechám na později. Zatím pořadí neovlivní; odpověď mohu změnit."},
    ],
  ...
  {
    id: "q-advertising-quick",
    key: "advertising",
    mode: "quick",
    title: "Přijmete povinné poděkování v reklamě?",
    help: "Jde o uvedení autora v reklamě na software, vedle běžného přiložení licence a copyrightu.",
    options: [
      {"value": "allowed", "label": "Ano, přijmu ho", "description": "Tato povinnost nezhorší pořadí licence; licence s poděkováním i bez něj zůstanou ve výběru."},
      {"value": "avoid", "label": "Ne, bez této povinnosti", "description": "Upřednostní licence bez povinného poděkování v reklamních materiálech."},
      {"value": "unknown", "label": "Nevím", "description": "Chybí mi informace. Tato odpověď pořadí neovlivní a zůstane označená jako neznámá."},
      {"value": "not-applicable", "label": "Není relevantní", "description": "Tento požadavek se projektu netýká. Při řazení licencí se vynechá."},
      {"value": "undecided", "label": "Nerozhodnuto", "description": "Volbu nechám na později. Zatím pořadí neovlivní; odpověď mohu změnit."},
    ],
  ...
  {
    id: "q-copyleft-trigger",
    key: "copyleftTrigger",
    mode: "advanced",
    title: "Kdy se má vyžadovat sdílení zdrojů?",
    help: "Vyberte situaci, při které chcete uplatnit povinnost sdílet zdrojový kód.",
    options: [
      {"value": "distribution", "label": "Při předání kopie", "description": "Upřednostní licence s povinnostmi vznikajícími při distribuci programu."},
      {"value": "network", "label": "Také při provozu v síti", "description": "Upřednostní licence s povinnostmi i při zpřístupnění softwaru přes síť."},
      {"value": "none", "label": "Bez povinného sdílení", "description": "Upřednostní licence bez copyleftu, tedy bez povinného sdílení úprav."},
      {"value": "unknown", "label": "Nevím", "description": "Chybí mi informace. Tato odpověď pořadí neovlivní a zůstane označená jako neznámá."},
      {"value": "not-applicable", "label": "Není relevantní", "description": "Tento požadavek se projektu netýká. Při řazení licencí se vynechá."},
      {"value": "undecided", "label": "Nerozhodnuto", "description": "Volbu nechám na později. Zatím pořadí neovlivní; odpověď mohu změnit."},
    ],
  ...
  {
    id: "q-notices-advanced",
    key: "notices",
    mode: "advanced",
    title: "Kolik povinných oznámení přijmete?",
    help: "Oznámení zahrnují například copyright, znění licence nebo předepsané poděkování.",
    options: [
      {"value": "minimal", "label": "Co nejméně", "description": "Upřednostní licence bez oznamovacích povinností nebo jen s minimálními požadavky."},
      {"value": "standard", "label": "Přijmu i rozsáhlejší", "description": "Upřednostní licence s běžnými nebo rozsáhlejšími oznámeními; jejich podmínky ukáže ve výsledku."},
      {"value": "unknown", "label": "Nevím", "description": "Chybí mi informace. Tato odpověď pořadí neovlivní a zůstane označená jako neznámá."},
      {"value": "not-applicable", "label": "Není relevantní", "description": "Tento požadavek se projektu netýká. Při řazení licencí se vynechá."},
      {"value": "undecided", "label": "Nerozhodnuto", "description": "Volbu nechám na později. Zatím pořadí neovlivní; odpověď mohu změnit."},
    ],
  },
  {
    ...
    key: "trademarks",
    mode: "advanced",
    title: "Chcete výslovné podmínky k ochranným známkám?",
    help: "Jde o pravidla pro použití jmen, značek a log souvisejících se softwarem.",
    options: [
      {"value": "important", "label": "Ano, chci je vyjasnit", "description": "Upřednostní licence, které výslovně řeší omezení ochranných známek. Neznamená to svolení používat logo."},
      {"value": "neutral", "label": "Nejsou rozhodující", "description": "Podmínky ochranných známek neovlivní pořadí licencí."},
      {"value": "unknown", "label": "Nevím", "description": "Chybí mi informace. Tato odpověď pořadí neovlivní a zůstane označená jako neznámá."},
      {"value": "not-applicable", "label": "Není relevantní", "description": "Tento požadavek se projektu netýká. Při řazení licencí se vynechá."},
      {"value": "undecided", "label": "Nerozhodnuto", "description": "Volbu nechám na později. Zatím pořadí neovlivní; odpověď mohu změnit."},
    ],
  },
  {
    ...
    key: "obligations",
    mode: "advanced",
    title: "Jaké povinnosti chcete ve výběru zohlednit?",
    help: "Vyberte preferovaný typ povinností. Úplný soubor podmínek najdete v detailu každé licence.",
    options: [
      {"value": "minimal", "label": "Co nejméně povinností", "description": "Upřednostní licence bez sdílení zdrojů a dalších nároků nad základní oznámení."},
      {"value": "notices", "label": "Zachování oznámení", "description": "Upřednostní licence požadující copyright, znění licence nebo oznámení; mohou mít i další povinnosti."},
      {"value": "source", "label": "Poskytnutí zdrojů", "description": "Upřednostní licence s povinností poskytnout zdrojový kód za stanovených podmínek."},
      {"value": "installation", "label": "Informace k instalaci úprav", "description": "Upřednostní licence, které za stanovených podmínek vyžadují informace pro instalaci upravené verze."},
      {"value": "unknown", "label": "Nevím", "description": "Chybí mi informace. Tato odpověď pořadí neovlivní a zůstane označená jako neznámá."},
      {"value": "not-applicable", "label": "Není relevantní", "description": "Tento požadavek se projektu netýká. Při řazení licencí se vynechá."},
      {"value": "undecided", "label": "Nerozhodnuto", "description": "Volbu nechám na později. Zatím pořadí neovlivní; odpověď mohu změnit."},
    ],
...
function validateAnswers(answers: unknown, context: RecommendationContext, options: AnswerValidationOptions = {}): AnswerValidation {
  ...
  for (const [key, value] of Object.entries(safeAnswers)) {
    ...
    if (uncertaintyStates.has(value) && options.allowUncertainty === true) continue;
...
function match(profile: MetadataLicenseProfile, answers: GuideAnswers): MatchResult {
  ...
  if (answers.commercialUse === "restricted") evaluate("permissions", 10, false, "matches commercialUse=restricted", "the metadata cannot evidence a commercial-use restriction");
  ...
  if (answers.proprietary === "preferred" || answers.proprietary === "required") conflicts.push("semantic.proprietary: proprietary intent requires separate terms");
  return { score: possible === 0 ? 0 : Math.round((earned / possible) * 100), reasons, matchedFields, conflicts, evaluatedFields };
}
...
function recommendFromProfilesUnsafe(profiles: readonly MetadataLicenseProfile[], answers: GuideAnswers, context: RecommendationContext): RecommendationResult {
  const validation = validateAnswers(answers, context, { allowUncertainty: true });
  ...
  const candidates = profiles.flatMap((profile) => {
    ...
    const status: CandidateStatus = unknowns.length ? "insufficient evidence" : scored.conflicts.length || scored.evaluatedFields === 0 ? "review required" : "good fit";
  ...
  if (branch === "source-available-or-proprietary") {
    trace.push("proprietary or source-available intent retained for score comparison");
    guidance.push("Proprietární nebo source-available záměr zůstává viditelný pro porovnání; samostatné podmínky musí posoudit právník.");
  }
  if (safeAnswers.commercialUse === "restricted") guidance.push("Omezení komerčního použití není v metadatech ověřitelné; kandidáti jsou proto pouze k ruční kontrole.");
  ...
  const noScoredRequirements = candidates.length > 0 && candidates.every((candidate) => candidate.score === 0 && candidate.conflicts.length === 0);
  if (noScoredRequirements) {
    trace.push("no concrete requirement was available for scoring");
    guidance.push("Nebyl zadán žádný konkrétní požadavek; licence jsou zobrazené s nulovým skóre.");
  }
  const intentNeedsReview = branch === "source-available-or-proprietary" || safeAnswers.commercialUse === "restricted";
  const outcome = !candidates.length ? "no-safe-match" : unknowns.length || noScoredRequirements || intentNeedsReview ? "insufficient-evidence" : "recommendation";
...
function recommendFromCatalogUnsafe(records: readonly CatalogMetadataRecord[], answers: GuideAnswers, context: RecommendationContext): RecommendationResult {
  ...
  const dependencyUncertainty = typeof safeAnswers.dependencies === "string" && uncertaintyStates.has(safeAnswers.dependencies);
  const dependencyInvalid = safeAnswers.dependencies !== undefined && !dependencyUncertainty && dependency.state !== "valid";
  const proprietaryIntent = ["allowed", "preferred", "required"].includes(safeAnswers.proprietary ?? "") || safeAnswers.openness === "closed";
  const branch = proprietaryIntent ? "source-available-or-proprietary" : "open-source";
  ...
  const dependencyGuidance = dependencyRequired
    ...
    : dependency.state === "malformed"
      ...
      ? "Dependencies were explicitly marked unknown; scoring continues without dependency compatibility."
  ...
  if (dependencyUncertainty) result.guidance.push("Závislosti byly označeny jako neznámé; skóre nezohledňuje jejich kompatibilitu.");
  return result;
}
