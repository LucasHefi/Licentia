...
export function guideMessage(message: string): string {
  const translations: Record<string, string> = {
    ...
    "patentPosition: does not evidence an express patent grant": "Není doložený výslovný patentový grant; samotné ukončení práv při sporu nestačí.",
    "patentPosition: has no evidenced patent position": "Patentové postavení není doložené.",
    "advertising: requires an advertising acknowledgment": "Vyžaduje poděkování v reklamě, které jste odmítli.",
    "semantic.advertising: requires an advertising acknowledgment": "Vyžaduje poděkování v reklamě, které jste odmítli.",
