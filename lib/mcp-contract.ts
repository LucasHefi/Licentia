...
export const MCP_TOOLS = [
  ...
  { name: "continue_license_guide", title: "Continue the license guide", description: "Continue the guide with all answers collected so far. Returns progress, the next full question, and after completion a validated advisory result with scores and per-license deficits.", inputSchema: GUIDE_CURSOR_INPUT_SCHEMA, outputSchema: objectOutput, annotations: readOnlyAnnotations },
